...
class EquipaController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.equipas.index', compact('equipas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.equipas.create', compact('grupos'));
    }
    ...
    public function store(StoreEquipaRequest $request)
    {
        ...
        return redirect()->route('frontend.equipas.index');
    }
    ...
    public function edit(Equipa $equipa)
    {
        ...
        return view('frontend.equipas.edit', compact('equipa', 'grupos'));
    }
    ...
    public function show(Equipa $equipa)
    {
        ...
        return view('frontend.equipas.show', compact('equipa'));
    }
