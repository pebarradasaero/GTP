...
class RegistoRegularidadeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.registoRegularidades.index', compact('registoRegularidades'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.registoRegularidades.create', compact('equipas', 'grupos'));
    }
    ...
    public function store(StoreRegistoRegularidadeRequest $request)
    {
        ...
        return redirect()->route('frontend.registo-regularidades.index');
    }
    ...
    public function edit(RegistoRegularidade $registoRegularidade)
    {
        ...
        return view('frontend.registoRegularidades.edit', compact('equipas', 'grupos', 'registoRegularidade'));
    }
    ...
    public function show(RegistoRegularidade $registoRegularidade)
    {
        ...
        return view('frontend.registoRegularidades.show', compact('registoRegularidade'));
    }
