...
class JuntasFreguesiaController extends Controller
{
    public function index()
    {
        ...
        return view('admin.juntasFreguesia.index', compact('juntasFreguesia'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.juntasFreguesia.create');
    }
    ...
    public function store(StoreJuntasFreguesiumRequest $request)
    {
        ...
        return redirect()->route('admin.juntas-freguesia.index');
    }
    ...
    public function edit(JuntasFreguesium $juntasFreguesium)
    {
        ...
        return view('admin.juntasFreguesia.edit', compact('juntasFreguesium'));
    }
    ...
    public function show(JuntasFreguesium $juntasFreguesium)
    {
        ...
        return view('admin.juntasFreguesia.show', compact('juntasFreguesium'));
    }
