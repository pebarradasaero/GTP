...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.juntas-freguesia.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('localidade') ? 'is-invalid' : '' }}" type="text" name="localidade" id="localidade" value="{{ old('localidade', '') }}">
