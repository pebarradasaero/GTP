                                    ...
                                    <tr data-entry-id="{{ $atividadeparticipante->id }}">
                                        ...
                                        <td>
                                            @can('atividadeparticipante_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.atividadeparticipantes.show', $atividadeparticipante->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('atividadeparticipante_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.atividadeparticipantes.edit', $atividadeparticipante->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('atividadeparticipante_delete')
                                                <form action="{{ route('frontend.atividadeparticipantes.destroy', $atividadeparticipante->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
