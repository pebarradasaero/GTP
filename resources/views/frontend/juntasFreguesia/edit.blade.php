    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.juntas-freguesia.update", [$juntasFreguesium->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nome">{{ trans('cruds.juntasFreguesium.fields.nome') }}</label>
                            <input class="form-control" type="text" name="nome" id="nome" value="{{ old('nome', $juntasFreguesium->nome) }}" required>
                            @if($errors->has('nome'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="localidade" id="localidade" value="{{ old('localidade', $juntasFreguesium->localidade) }}">
