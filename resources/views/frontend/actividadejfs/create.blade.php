    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.actividadejfs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Actividadejf::SIMPATIA_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="simpatia_{{ $key }}" name="simpatia" value="{{ $key }}" {{ old('simpatia', '') === (string) $key ? 'checked' : '' }} required>
