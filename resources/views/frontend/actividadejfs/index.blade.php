                                    ...
                                    <tr data-entry-id="{{ $actividadejf->id }}">
                                        ...
                                        <td>
                                            @can('actividadejf_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.actividadejfs.show', $actividadejf->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('actividadejf_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.actividadejfs.edit', $actividadejf->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('actividadejf_delete')
                                                <form action="{{ route('frontend.actividadejfs.destroy', $actividadejf->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
